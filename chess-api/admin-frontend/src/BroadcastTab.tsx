  ...
  return (
    <div className="max-w-2xl">
      ...
      <textarea
        ...
        rows={4}
        className="w-full px-3 py-2 text-sm bg-[#1a1a1a] border border-[#333] rounded-lg text-[#e0e0e0] placeholder-[#555] focus:outline-none focus:border-[#4a9eff] resize-none"
      />
