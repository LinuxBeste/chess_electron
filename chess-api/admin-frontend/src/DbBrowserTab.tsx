      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        <div className="lg:col-span-1">
          <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-4">
            ...
            <button
              onClick={loadTables}
              className="mt-3 flex items-center gap-1 px-2 py-1 text-xs text-[#888] hover:text-[#ccc]"
            >
                      ...
                      <table className="w-full text-xs">
                        <thead>
                          <tr className="text-[#888] uppercase border-b border-[#2a2a2a]">
                            ...
                            {result.columns.map((col, idx) => (
                              <th
                                key={col}
                                className="text-left px-3 py-2 font-mono cursor-pointer hover:text-[#ccc] select-none"
                        ...
                        <tbody>
                          {(sortedRows || result.rows).length === 0 ? (
                            <tr>
                              <td colSpan={result.columns.length + 1} className="px-3 py-8 text-center text-[#666]">
                                No rows returned.
                              </td>
                            </tr>
                          ) : (
