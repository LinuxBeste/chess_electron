...
| `DATABASE_URL`                  | `postgresql://...`       | yes\*    | string | PostgreSQL connection string                           |
...
| `ADMIN_PASSWORD`                | (random)                 | yes\*    | string | Admin password (auto-generated if not set)             |
...
| `REDIS_URL`                     | _(empty)_                | no       | string | Redis URL (set to enable Redis persistence)            |
